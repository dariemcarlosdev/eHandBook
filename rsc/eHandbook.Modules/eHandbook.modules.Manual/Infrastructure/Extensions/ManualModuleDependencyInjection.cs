...
{
    public static class ManualModuleDependencyInjection
    {
        ...
        public static IServiceCollection AddManualModuleDIServiceCollection(this IServiceCollection services)
