...
namespace eHandbook.Infrastructure.Middlewares
{
    ...
    /// </summary>
    public class MyGlobalExceptionHandlerMiddleware : IMiddleware
    {
        private readonly ILogger<MyGlobalExceptionHandlerMiddleware> _logger;
        /// <summary>
        /// Ctor.
        /// </summary>
        /// <param name="logger"></param>
        public MyGlobalExceptionHandlerMiddleware(
            ILogger<MyGlobalExceptionHandlerMiddleware> logger) => _logger = logger;
